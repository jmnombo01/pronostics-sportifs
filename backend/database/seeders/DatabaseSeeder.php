...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 7. Création de Pronostics réalistes de chaque catégorie (Combinés de plusieurs matchs pour Côte 5, 10, 50)
        $predictions = [
            [
                ...
                'analysis' => 'Combiné de 3 matchs sélectionnés par nos algorithmes et nos experts. La cote cumulée (1.65 × 1.80 × 1.75 = 5.18) offre un superbe ratio sécurité/gain pour ce début de semaine.',
                'status' => 'PENDING',
            ...
            [
                ...
                'competition' => 'Europe - Combiné VIP',
                'country' => 'Europe',
                'championship' => 'Combiné Premier League & Serie A',
                ...
                'analysis' => 'Deuxième ticket Côte 5 de la semaine. Chaque match a été analysé individuellement : Arsenal est intraitable à l\'Emirates et l\'Inter reste sur 4 succès dans le derby de Milan.',
                'status' => 'PENDING',
            ...
            [
                ...
                'analysis' => 'Combiné de 4 matchs pour atteindre notre cote 10 exclusive. Notre équipe conseille de sécuriser votre mise principale sur la Côte 5 et d\'allouer 2% de bankroll sur ce combiné.',
                'status' => 'PENDING',
            ...
            [
                ...
                'analysis' => 'Notre combiné phare de la semaine réunit 6 sélections européennes pour une cote finale multipliée de 54.20. Réservé aux abonnés VIP.',
                'status' => 'PENDING',
            ...
            [
                'title' => '📈 MONTANTE ÉTAPE 2 : Juventus vs Naples',
                'competition' => 'Serie A',
                'country' => 'Italie',
                'championship' => 'Serie A',
                'match_date' => $now->copy()->addDay()->format('Y-m-d'),
            ...
            [
                'title' => '⚡ COMBINÉ CÔTE 5 (HISTORIQUE GAGNÉ - 3 MATCHS)',
                ...
                'analysis' => 'Combiné Côte 5 gagnant à 100% ! Les 3 matchs du ticket ont été validés sans accroc.',
                'status' => 'WON',
                'image_url' => 'https://images.unsplash.com/photo-1553778263-73a83bab9b0c?w=600&q=80',
                'is_published' => true,
            ],
